...
from aliyunsdkcore.credentials.credentials import AccessKeyCredential, BearTokenCredential, SecurityCredential
...
class RsaKeyPairFetcher(object):
    ...
    def get_credentials(self):
        if self._session_credential is None or self.is_expiration:
            self.get_profile()
            return
...
class ProfileResolve:
    ...
    def resolve_type_of_ecs_ram_role(self):
        ...
        profile = fetcher.get_credentials()
